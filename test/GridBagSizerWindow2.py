...
class GridBagSizerWindow2(wx.Frame):

    def __init__(self, *args, **kwargs):
        super(GridBagSizerWindow2, self).__init__(*args, **kwargs)
    ...
    def init_ui(self):
        ...
        icon = wx.StaticBitmap(panel, bitmap=wx.Bitmap('../resources/images/exec.png'))
