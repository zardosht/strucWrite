...
class ListCtrlLeft(wx.ListCtrl):
    def __init__(self, parent, id):
        ...
        images = ['../resources/images/java.png', '../resources/images/gnome.png', '../resources/images/mozilla.png']
...
class Reader(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        toolbar.AddLabelTool(1, 'Exit', wx.Bitmap('../resources/images/stock_exit.png'))
        toolbar.Realize()
